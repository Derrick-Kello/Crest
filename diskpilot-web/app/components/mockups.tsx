  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 px-3 py-[10px]">
        ...
        <span className="text-[12px] font-medium text-ink">DiskPilot</span>
...
const rows = [
  ...
  },
  {
    ...
    subtitle: "DiskPilot action · 41.2 GB found",
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 border-t border-hairline px-4 py-[10px]">
        ...
        <span className="text-[12px] text-mute">DiskPilot</span>
...
/** The macOS menu bar strip, with DiskPilot's own item lit up. */
...
/** The product shot: a menu bar with DiskPilot open under it, command bar alongside. */
...
export function ClipboardMock() {
  const items = [
    ...
    { text: "https://diskpilot.app/download", meta: "2 minutes ago" },
