...
const faqs = [
  ...
  },
  {
    ...
    a: "DiskPilot only reads your home folder, never system files. Every scan lists what it found with a size and a description of what happens if it goes. Removal moves things to the Trash, so anything you disagree with is one drag back.",
  },
  {
    q: "Does it need Accessibility permission?",
    a: "No. The shortcut is registered with the system hot key API, so macOS delivers that one combination to DiskPilot instead of the app watching every keystroke. Colour picking uses the system sampler, so it does not need Screen Recording either.",
  },
  {
    q: "Can I change the shortcut?",
    a: "Yes. ⌥Space is the default because it sits next to Spotlight without colliding with it. Pick any combination in Settings, and DiskPilot tells you straight away if another app has claimed it.",
  },
  {
  ...
  {
    q: "Is the app signed?",
    a: "Not yet. Signing and notarisation need a paid Apple Developer ID, which DiskPilot does not have at launch. That is why the install needs an xattr line afterwards, and why the dmg needs an Open Anyway on first run. Both go away once it is notarised.",
  },
  {
    q: "Do I need Docker?",
      ...
      <main className="flex-1">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,460px)_minmax(0,1fr)] lg:gap-14">
            <div className="reveal">
              ...
              <p className="mt-6 max-w-[420px] text-[16px] leading-[1.6] text-body">
                DiskPilot answers the question in the menu bar, before you have to go looking for a
            ...
            <div className="reveal grid overflow-hidden rounded-lg border border-hairline bg-surface lg:grid-cols-2">
              <div className="p-6 sm:p-10">
                ...
                <p className="mt-3 max-w-[420px] text-[15px] leading-[1.6] text-mute">
                  ...
                  hundredth. DiskPilot actions sit in the same list: quick scan, clean developer
          ...
          <div className="mt-12 grid gap-4 md:grid-cols-3">
            {[
              ...
              },
              {
                icon: EyedropperIcon,
                t: "Colour picker",
                d: "The system magnifier samples the pixel, so DiskPilot never needs Screen Recording. The value lands on your clipboard in the format you chose.",
              },
              {
                icon: BatteryIcon,
                t: "Menu bar metric",
        ...
        <Section id="privacy">
          <SectionHeading
            ...
            subtitle="DiskPilot asks for almost nothing."
          />
              ...
              <div className="mx-auto mt-12 grid max-w-[900px] gap-4">
                <div className="rounded-lg border border-hairline bg-canvas/60 p-6">
                  ...
                  <CopyCommand
                    className="mt-5"
                    command={[
                      "brew install --cask derrick-kello/tap/diskpilot",
                      "xattr -dr com.apple.quarantine /Applications/DiskPilot.app",
                    ]}
                  />
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-lg border border-hairline bg-canvas/60 p-6">
                    ...
                    <p className="mt-2 text-[14px] leading-[1.6] text-mute">
                      DiskPilot is not notarised by Apple yet, so macOS marks it as quarantined and
